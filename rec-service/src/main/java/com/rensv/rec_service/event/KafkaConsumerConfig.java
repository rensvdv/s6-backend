package com.rensv.rec_service.event;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Song> consumerFactory() {
        ...
        JsonDeserializer<Song> deserializer = new JsonDeserializer<>(Song.class);
        deserializer.addTrustedPackages("*");

        Map<String, Object> config = new HashMap<>();
        config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "rec-service-group");
